var config = {
    ...
    chapters: [
        ...
        },
        {
            ...
            title: 'Nodes',
            image: '',
            description: '<p>Each network “node” point consists of at least one router connection. Most nodes are recipient connections: NYC Mesh users who receive web access through the network. Access is distributed by hubs, or clusters of routers and servers, and supernodes, which serve as high-bandwidth thresholds to the Internet at large..</p>',
            location: {
